...
function getObjectImportance(roomType, objectName) {
  const highByRoom = {
    bathroom: ["sink", "mirror", "toilet", "bathtub_or_shower"],
    living_room: ["sofa", "coffee_table", "tv", "tv_stand"],
  };
...
export async function analyzeBathroomObjectsWithAi(
  ...
  const prompt = [
    ...
    "Focus only on major room objects and stable décor that matter for room state.",
